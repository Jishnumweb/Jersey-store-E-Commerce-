...
function Registerpage() {
    ...
    return (
        <div className="container ">
            <div>
                <div className='h-screen lg:flex lg:flex-row flex-col justify-center items-center lg:mt-0 mt-[60px]'>
                    <div className='lg:w-1/2 lg:h-1/2 w-full bg-[#fff] shadow-lg flex flex-col item-center justify-start py-4 text-center text-[#FF0000]'>
                        <h5 className='font-bold mb-0 lg:text-base text-[15px]'>CREATE ACCOUNT</h5>
                        <div>
