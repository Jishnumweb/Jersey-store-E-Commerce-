    ...
    <div className='mt-[100px] container'>
      ...
      <form onSubmit={handleSubmit}>
        <div className='flex flex-col gap-3 justify-center items-center'>
          <input type="text" name="title" placeholder='Enter title' className='border border-black placeholder:text-[14px] w-[500px] p-2 text-white' onChange={handleChange} />
          <input type="text" name="description" placeholder='Enter description' className='border border-black placeholder:text-[14px] w-[500px] p-2 text-white' onChange={handleChange} />
          ...
          <input type="text" name="team" placeholder='Enter team name' className='border placeholder:text-[14px] border-black w-[500px] p-2 text-white' onChange={handleChange} />
          <input type="file" name="image" className='border placeholder:text-[14px] border-black w-[500px] p-2 text-white' onChange={handleImageChange} />
          <input type="text" name="price" placeholder='Enter price' className='border placeholder:text-[14px] border-black w-[500px] p-2 text-white' onChange={handleChange} />
